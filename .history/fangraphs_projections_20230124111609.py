...
def get_projections(pos, stats, type_stats):
    ...
    cols = ['PlayerName', 'Pos', 'ADP', 'Team', 'ShortName', 'G', 'AB', 'PA', 'H', '1B', '2B', '3B',
       'HR', 'R', 'RBI', 'BB', 'IBB', 'SO', 'HBP', 'SF', 'SH', 'GDP', 'SB',
       'CS', 'AVG', 'OBP', 'SLG', 'OPS', 'wOBA', 'BB%', 'K%', 'BB/K', 'ISO',
       'Spd', 'BABIP', 'UBR', 'GDPRuns', 'wRC', 'wRAA', 'UZR', 'wBsR',
       'BaseRunning', 'WAR', 'Off', 'Def', 'wRC+', 'InterSD', 'InterSK',
       'IntraSD', 
